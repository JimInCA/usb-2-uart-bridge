...
/* Symbols to be used with PORT driver */
#define BOARD_INITPINS_UART3_RX_PORT PORTC                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_UART3_RX_PIN 16U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_UART3_RX_PIN_MASK (1U << 16U)      /*!<@brief PORT pin mask */
                                                          /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_INITPINS_UART3_TX_PORT PORTC                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_UART3_TX_PIN 17U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_UART3_TX_PIN_MASK (1U << 17U)      /*!<@brief PORT pin mask */
                                                          /* @} */
